/*
 * Niche Toolbox Lite by 0znzw (English Version)
 * Majority code is by 0znzw || licensed under MIT license.
 */

/* NOTE:
  This is the lite version of Niche Toolbox, access the full version at:
...
*/
  ...
  (function (Scratch) {
    ...
    class NicheToolboxLite {
        ...
        getInfo() {
            return {
                ...
                blocks: [{
                  ...
                  text: "Unlock all Blocks with the Full Version"
                }], menus: {
        ...
        getFull() {
          let popup = ["Clicking Continue will send you to the Full Version of Niche Toolbox \n Continue?"];
          if (confirm(popup.join("\n\n"))) { window.open("https://surv.is-a.dev/unsafe-extensions/", "_blank").focus() }
        }
