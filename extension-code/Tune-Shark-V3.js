...
"data:image/svg+xml;base64,";
  ...
  // Pizzicato Library (Web Audio API, but with Premade Effects and Stuff) -- Modifed File
  // uses MIT License
  ...
  class SPtuneShark3 {
    ...
    setBit(args) {
      ...
      const bitcrush = new Pizzicato.Effects.Bitcrusher({
        bitDepth: Scratch.Cast.toNumber(args.FREQ), frequencyReduction: Scratch.Cast.toNumber(args.PEAK)
      });
      this.updateEffect(bitcrush, sound, "BITCRUSHER", args);
    }
